...
const CATALOG: GameSeed[] = [
  ...
  },
  {
    slug: 'dice_party',
    name: 'Dice Party',
    description: 'Roll, hold, re-roll: fill 13 categories on your score card. Yacht scores 50!',
    minPlayers: 2,
    maxPlayers: 4,
  ...
  },
  {
    slug: 'checkers',
    name: 'Checkers',
    description: 'Jump, capture and crown your kings. The timeless duel of draughts.',
    minPlayers: 2,
    maxPlayers: 2,
    avgDurationMinutes: 10,
    supportsBots: true,
  ...
  },
  {
    slug: 'reversi',
    name: 'Reversi',
    description: 'Flip your rival\'s discs by trapping them. Own the corners, own the board.',
    minPlayers: 2,
    maxPlayers: 2,
  ...
  },
  {
    slug: 'backgammon',
    name: 'Backgammon',
    description: 'Race your checkers home with dice and nerve. Hit blots, build primes, bear off first.',
    minPlayers: 2,
    maxPlayers: 2,
  ...
  },
  {
    slug: 'dots_boxes',
    name: 'Dots & Boxes',
    description: 'Connect the dots, close the boxes, steal the chains. Play with 2, 3 or 4 friends.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'sea_battle',
    name: 'Sea Battle',
    description: 'Hide your fleet, hunt theirs. Hits fire again — sink all five ships to win.',
    minPlayers: 2,
    maxPlayers: 2,
    avgDurationMinutes: 10,
    supportsBots: true,
  ...
  },
  {
    slug: 'mancala',
    name: 'Mancala',
    description: 'Sow stones around the board, capture across it, land in your store to go again.',
    minPlayers: 2,
    maxPlayers: 2,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'mines',
    name: 'Mines',
    description: 'Competitive minesweeper: find more mines than your rivals on one shared field. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'go_fish',
    name: 'Go Fish',
    description: 'Ask, collect, book! The classic card game of memory and luck for 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'darts',
    name: 'Darts',
    description: '301, double-out. Steady the drifting reticle, hit trebles, and check out on a double. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'bowling',
    name: 'Bowling',
    description: 'Five frames, strikes, spares and splits. Line up, swipe with spin and hit the pocket. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 8,
    supportsBots: true,
  ...
  },
  {
    slug: 'big_two',
    name: 'Big Two',
    description: 'The climbing card game: singles, pairs and poker hands — 2s are high, first to shed every card wins. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 10,
    supportsBots: true,
  ...
  },
  {
    slug: 'cup_pong',
    name: 'Cup Pong',
    description: 'The party classic: arc your throws into the ten-cup triangle, sink both balls for balls back, re-rack at three. 2 players or 2v2.',
    minPlayers: 2,
    maxPlayers: 4,
  ...
  },
  {
    slug: 'mini_golf',
    name: 'Mini Golf',
    description: 'Nine themed holes with walls, bumpers and sand — drag back to putt, lowest total wins. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 12,
    supportsBots: true,
  ...
  },
  {
    slug: 'hearts',
    name: 'Hearts',
    description: 'The evasion trick-taker: dodge hearts and the Queen of Spades, pass three cards, or shoot the moon. 2–4 players.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 15,
    supportsBots: true,
