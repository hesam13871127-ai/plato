...
const CATALOG: GameSeed[] = [
  ...
  },
  {
    slug: 'snakes_ladders',
    name: 'Snakes & Ladders',
    description: 'Roll, climb ladders and dodge snakes in a 2–4 player race to 100! Every board is a new adventure.',
    minPlayers: 2,
    maxPlayers: 4,
  ...
  },
  {
    slug: 'dots_boxes',
    name: 'Dots & Boxes',
    description: 'Connect the dots, claim the squares. The greediest architect wins — 2–4 players!',
    minPlayers: 2,
    maxPlayers: 4,
