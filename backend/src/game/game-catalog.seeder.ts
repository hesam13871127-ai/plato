...
const CATALOG: GameSeed[] = [
  ...
  },
  {
    slug: 'minesweepers',
    name: 'Minesweepers',
    description: 'Plato sweeper duel — reveal the grid, dodge the ten mines, flood-fill the basins and out-score the table.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 6,
    supportsBots: true,
  ...
  },
  {
    slug: 'basketball',
    name: 'Basketball',
    description: 'Hoops arcade — drag to aim at the rim, tune the power and drain ten shots from the court.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 6,
    supportsBots: true,
  ...
  },
  {
    slug: 'archery',
    name: 'Archery',
    description: 'Ten-ring target with a living wind — compensate, breathe and loose fifteen arrows for the gold.',
    minPlayers: 2,
    maxPlayers: 4,
    avgDurationMinutes: 7,
    supportsBots: true,
