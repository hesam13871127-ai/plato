...
class GameBoardDispatcher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (session.gameSlug) {
      ...
      case 'minesweepers':
        return MinesweeperBoard(session: session, mySeat: mySeat, onAction: onAction);
      case 'gofish':
        return GoFishBoard(session: session, mySeat: mySeat, onAction: onAction);
      case 'poker':
        return PokerBoard(session: session, mySeat: mySeat, onAction: onAction);
      default:
