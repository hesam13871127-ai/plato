...
class GameTutorials {
  ...
  static const Map<String, List<TutorialStep>> _data = {
    ...
    'minesweepers': [
      TutorialStep(
        emoji: '💣',
        titleEn: 'Shared board, hidden mines',
        titleFa: 'بورد مشترک، مین‌های پنهان',
        bodyEn: 'A 9×9 grid hides ten mines. On your turn tap a hidden cell to reveal it. Your score is your safe cells.',
        bodyFa: 'جدول ۹×۹ ده مین را پنهان کرده. در نوبتت روی خانهٔ مخفی بزن تا آشکار شود. امتیازت تعداد خانه‌های امنت است.',
      ),
      TutorialStep(
        emoji: '🔢',
        titleEn: 'Numbers guide you',
        titleFa: 'عددها راهنمایت هستند',
        bodyEn: 'A revealed number tells how many of its eight neighbours hide mines. Zero basins flood-fill automatically.',
        bodyFa: 'عدد روی خانه می‌گوید چند تا از هشت همسایه‌اش مین دارد. خانهٔ صفر کل حوزهٔ خالی را خودکار باز می‌کند.',
      ),
      TutorialStep(
        emoji: '💥',
        titleEn: 'Hit a mine? Ouch!',
        titleFa: 'به مین خوردی؟ آخ!',
        bodyEn: 'A mine costs five points and marks the cell red, but the sweep continues until every safe cell is open.',
        bodyFa: 'مین پنج امتیاز کم می‌کند و خانه را قرمز می‌کند، ولی جارو تا باز شدن همهٔ خانه‌های امن ادامه دارد.',
      ),
      TutorialStep(
        emoji: '🏆',
        titleEn: 'Most safe cells wins',
        titleFa: 'بیشترین خانهٔ امن برنده',
        bodyEn: 'When the board is fully swept, the player with the most safe cells takes the flag. Think logically!',
        bodyFa: 'وقتی بورد کاملاً جارو شد، کسی که بیشترین خانهٔ امن را باز کرده پرچم را می‌گیرد. منطقی فکر کن!',
      ),
    ],
    'basketball': [
      TutorialStep(
        emoji: '🏀',
        titleEn: 'Drag to aim',
        titleFa: 'بکش و نشانه بگیر',
        bodyEn: 'Drag on the court to place your crosshair over the rim, then tune the power slider and shoot.',
        bodyFa: 'روی زمین بکش تا نشانه را روی حلقه بگذار، بعد قدرت را تنظیم کن و شوت بزن.',
      ),
      TutorialStep(
        emoji: '🎯',
        titleEn: 'The sweet spot',
        titleFa: 'نقطهٔ شیرین',
        bodyEn: 'The rim radius is tight — land inside it or bank softly off the backboard square to score two each time.',
        bodyFa: 'شعاع حلقه تنگ است — داخلش بنشین یا از مربع تخته به‌آرامی بانکی کن تا هر بار دو امتیاز بگیری.',
      ),
      TutorialStep(
        emoji: '💪',
        titleEn: 'Power matters',
        titleFa: 'قدرت مهم است',
        bodyEn: 'Weak arms drop the ball short; full power flies true. Watch the deterministic wobble tighten as power rises.',
        bodyFa: 'بازوی ضعیف توپ را کوتاه می‌اندازد؛ قدرت کامل دقیق‌تر می‌رود. با افزایش قدرت، لرزش هم کم می‌شود.',
      ),
      TutorialStep(
        emoji: '🏆',
        titleEn: 'Ten shots decide it',
        titleFa: 'ده شوت تعیین‌کننده',
        bodyEn: 'Five rounds of two shots each — ten total. Highest total after ten wins, ties split.',
        bodyFa: 'پنج دورِ دو شوتی — مجموع ده شوت. بیشترین امتیاز بعد از ده شوت می‌برد، مساوی تقسیم می‌شود.',
      ),
    ],
    'archery': [
      TutorialStep(
        emoji: '🏹',
        titleEn: 'The ten-ring target',
        titleFa: 'سیبل ده‌امتیازی',
        bodyEn: 'Gold inner is ten, then nine down to one on the outer white. Off the target is a miss. Aim dead centre!',
        bodyFa: 'مرکز طلایی ده، بعد نه تا یک در سفیدیِ بیرونی. بیرونِ سیبل خطاست. دقیقاً وسط را نشانه بگیر!',
      ),
      TutorialStep(
        emoji: '💨',
        titleEn: 'Read the wind',
        titleFa: 'باد را بخوان',
        bodyEn: 'Each round has a steady wind arrow that drifts your arrow. Harder bots compensate; you should too.',
        bodyFa: 'هر دور یک بادِ ثابت دارد که تیرت را منحرف می‌کند. ربات‌های سخت‌ جان جبران می‌کنند؛ تو هم جبران کن.',
      ),
      TutorialStep(
        emoji: '🎯',
        titleEn: 'Aim and power',
        titleFa: 'نشانه و قدرت',
        bodyEn: 'Drag to aim, set the power slider and loose. Low power spreads and drops; high power flies tight.',
        bodyFa: 'بکش و نشانه بگیر، قدرت را تنظیم کن و رها کن. قدرت کم پراکنده و افتاده می‌رود؛ قدرت زیاد تنگ و دقیق.',
      ),
      TutorialStep(
        emoji: '🏆',
        titleEn: 'Fifteen arrows',
        titleFa: 'پانزده تیر',
        bodyEn: 'Five rounds of three arrows — fifteen total per seat. Highest sum after fifteen takes the gold.',
        bodyFa: 'پنج دورِ سه‌تیری — مجموع پانزده تیر برای هر نفر. بیشترین مجموع بعد از پانزده تیر طلا را می‌گیرد.',
      ),
    ],
  };
}
